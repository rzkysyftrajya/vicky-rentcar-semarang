              ...
              <CardContent className="space-y-6">
                {[
                  ...
                  },
                  {
                    ...
                    action: () => window.open("https://maps.google.com/?q=Jl.+Pringgan+no+11+gg+Bung+Boniran+Medan"),
                    color: "blue",
                  },
                ].map((contact, index) => (
                  <div
          ...
          <Card className="glass-dark border-emerald-500/30">
            ...
            <CardContent>
              <div className="aspect-video rounded-lg overflow-hidden">
                <iframe
                  src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3982.0853!2d98.6501!3d3.5952!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x0%3A0x0!2zM8KwMzUnNDIuNyJOIDk4wrAzOScwMC40IkU!5e0!3m2!1sen!2sid!4v1234567890"
                  width="100%"
                  height="100%"
                  style={{ border: 0 }}
                  allowFullScreen
